-- Phase A : aligner BÉNÉVOLE et STAGIAIRE (lecture limitée + présences, pas de modification)
...
-- ── children : lecture séparée, écriture réservée au staff complet ──
...
-- ── inscriptions activités : STAGIAIRE retiré ──
