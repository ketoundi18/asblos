...
| 2026-06 | Page « sans CSS » en dev (layout.css 404) | **Build/lint vert ≠ CSS chargé** ; cache `.next` corrompu par 2 serveurs ou build+dev simultanés | **`npm run css:check` après chaque modification** ; prévenir l'utilisateur ; voir règle agentic § CSS |
...
5. **Pitch avant checklist DEMO.md** — toujours valider migrations 001–037 + parcours 2× + e2e vert.
