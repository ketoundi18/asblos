      ...
      <Card className="mt-6">
        ...
        <CardContent className="grid gap-4 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input id="school_name" name="school_name" defaultValue={draft?.school_name} />
          </div>
          <div className="space-y-2">
            ...
            <Input
              ...
              defaultValue={draft?.school_class}
            />
          </div>
        </CardContent>
      </Card>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input
                ...
                defaultValue={draft?.emergency_contact_name}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                type="tel"
                defaultValue={draft?.emergency_contact_phone}
              />
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          <label className="flex items-center gap-3 rounded-lg border p-3">
            <input
              ...
              name="image_rights"
              className="h-4 w-4"
              defaultChecked={draft?.image_rights}
            />
          ...
          <label className="flex items-center gap-3 rounded-lg border p-3">
            <input
              ...
              className="h-4 w-4"
              defaultChecked={draft?.outing_authorization}
            />
